...
let reviews;
const placeId =
  "EjExNDE5IEdsZW5uIFN0IFNXIHN1aXQgMjA0LCBEZWNhdHVyLCBBTCAzNTYwMywgVVNBIiQaIgoWChQKEgkLVDB2d4RiiBHX5Nek11qoCBIIc3VpdCAyMDQ";
const apiKey = "AIzaSyBBeJPYcvMnLdJXma82OUGRgCtaFIP2bmo";
const apiUrl = `https://maps.googleapis.com/maps/api/place/details/json?place_id=${placeId}&key=${apiKey}`;

fetch(apiUrl)
  .then((response) => response.json())
  .then((data) => {
    // Handle the response data (reviews)
    reviews = data.result.reviews;
    console.log("Google Reviews = ", reviews);
    // Now you can proceed to display these reviews on your website.
  })
